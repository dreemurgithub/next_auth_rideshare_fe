...
export default function Navbar() {
    ...
    return <>
        <nav id={'navbar'} className={`navbar navbar-expand-lg bg-body-tertiary ${state.bs_theme}`} data-bs-theme={state.bs_theme}>
            <div>
        ...
        <div className={'collapse navbar-collapse'} id="navbar-nav">
            <Link className={'navbar-brand nav-link'} href={'/'}>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
                     className="bi bi-car-front-fill " viewBox="0 0 50 50" style={ { marginBottom:'-1.5em',marginRight:'-1em' } }>
                    <path
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div className="dropdown">
                    <Link href={'#'} className="dropdown-toggle nav-link" role="button"
                        ...
                        All Drivers </Link>
                    <ul className="dropdown-menu" style={{marginLeft: '1em'}}>
